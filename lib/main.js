...
var vmQuiz = new Vue({
    ...
    data: {
        ...
        allQuestions: [{
            ...
            choices: ["The institution is under a sponsoring organization", "The out-side-school-hours care program is part of the center’s CACFP", "The out-side-school-hours care center has an occupancy limit over 100 persons"],
            explanation: "Remember, if an outside-school-hours care center is operated as part of a childcare center that participates in the CACFP, it will require CACFP enrollment documentation.",
            correct: 1
        }, {
            question: "For how long is child enrollment documentation valid?",
            ...
            explanation: "Remember, child enrollment documentation is valid for one year from the date that it was signed by the parent or guardian.",
            correct: 1
        }, {
            question: "Which of the following is a consequence of missing or incomplete enrollment documentation?",
            choices: ["Your institution will be required to retake this training", "Your institution will be required to produce proper enrollment documentation within 30 days", "There will be reimbursement disallowances"],
            explanation: "Missing or incomplete enrollment documentation could cost the center money as reimbursement is disallowed for participants without proper enrollment documentation.",
            correct: 2
        }, {
            question: "Which of the following describes information that must be recorded on enrollment documentation?",
            choices: ["Parent’s or guardian’s signature, days and hours of care, and meals normally received", "Participant’s date of birth and family’s household income", "The participant’s ethnic and racial data and any dietary restrictions"],
            explanation: "Enrollment documentation must include information on each child's normal days and hours of care, information on meals normally received while in care, and be signed by a parent or guardian.",
            correct: 0
        }, {
            question: "What is the best practice when a child withdraws from the CACFP?",
            choices: ["Document the participant withdrawal date on the enrollment documentation", "Destroy the enrollment form to keep it confidential", "Send the enrollment form to the State agency explaining the withdrawal"],
            explanation: "When a child withdraws, write the participant’s withdrawal date on the enrollment documentation and then re-file the documentation.",
            correct: 0
        }, {
            question: "How long must enrollment documentation be kept on file?",
            choices: ["One year after the participant withdraws", "30 days after the participant withdraws", "3 years plus the current year"],
            explanation: "Enrollment documentation must be maintained on file for 3 years plus the current year. Additionally, it is best practice to have a policy in place that specifies how the institution will retain the records for the required 3 years plus the current year.",
            correct: 2
        }]
    },
