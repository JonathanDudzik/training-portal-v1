...
var vmQuiz = new Vue({
    ...
    data: {
        ...
        allQuestions: [
            {
                question: "According to the training, where is it suggested to find NC CACFP meal count tools?",
                choices: ["State agency face-to-face trainings.", "On the USDA FNS webpage.", "At www.nutritionnc.com under forms."],
                explanation: "Meal count tools are found on our website, www.nutritionnc.com under CACFP forms.",
                correct: 2
            },
            {
                question: "If staff eat meals with the CACFP participants, what should be done? ",
                choices: ["Include the staff meals with your monthly CACFP claim.", "Record the staff meals, but do not include them in the monthly claim.", "Staff should not eat CACFP Meals."],
                explanation: "If staff eat with the children at the child care center, or with adults at an adult day care center, those meals must also be recorded. Although these meals are not reimbursable, since program funds are being used to feed staff, those costs must be accounted for.",
                correct: 1
            },
            {
                question: "If a participant was offered a meal, but was not marked in attendance for the day, what should be done?",
                choices: ["The participant's meal should not be claimed", "The participant's meal should be claimed as long as the meal offered was recorded", "The meal count alone should be used to verify that the participant was in attendence"],
                explanation: "Accurate attendance records are critically important to the reimbursable meal count, and if a participant is not marked in attendance for the day, the meals will not be counted as reimbursable.",
                correct: 0
            },
        ],
    },
